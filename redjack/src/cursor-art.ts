 ...
 *
 *   npx tsx tools/dumpcursors.ts RJDisk1/RedJack/RedJack.exe --out <this file> --const RJ_CURSORS
 *
 * 12 `CURS.*` resources out of `RedJack.exe`, minus the 7 under old numeric names that no script can name (curs2000, curs4000, curs5000, curs6000, curs7000, curs8000, curs9000).
...
export const RJ_CURSORS: Record<string, CursorArt> = {
  ...
  crosshair: { hx: 16, hy: 16, fallback: "pointer",
    bits: "" },
  ...
  godown: { hx: 15, hy: 15, fallback: "pointer",
    bits: "" },
  ...
  gostraight: { hx: 15, hy: 12, fallback: "pointer",
    bits: "" },

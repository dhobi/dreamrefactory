...
import type { FileProvider } from "../src/engine/setscripts";
...
export function gamefilesRoot(): string {
  return process.env.TAOOT_GAMEFILES ?? "gamefiles";
}
 ...
 * differ — `BIN` is the build the recovered addresses in src/engine refer to

 ...
 *
 *   npx vitest run tests/auto/interp.ts
 *   TAOOT_BLKJACK=/path/to/BLKJACK.STG npx vitest run tests/auto/interp.ts
 */
...
import { Interpreter, ScriptInstance, Value } from "../../src/engine/interp";
import { registerCoreBuiltins } from "../../src/engine/builtins/core";

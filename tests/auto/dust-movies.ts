 ...
 *
 *   npx vitest run tests/auto/dust-movies.ts
 *
 * The claims are the ones src/df/mov-v1.ts's module comment makes; the layout
...
import { readAudioHeader } from "../../src/df/audio";
import {
  compositeFrameV1,
  movFileFromV1,
  readMovFileV1,

 ...
 * in src/df/banks.ts, so it runs without gamefiles/ — the editor must
...
import { Container, DFContainerFile, readContainerFile, writeContainerFile } from "../../src/df/container";
import { decodeAudioContainer, encodeAudioContainer, encodeV41 } from "../../src/df/audio";
import { buildBankFile } from "../../src/df/banks-build";
import { i16, i32 } from "../../src/df/build";
import {
  CHUNK_ID_FIELD,
  LOOP_ORDER_MAX,

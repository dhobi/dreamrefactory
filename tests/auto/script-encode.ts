/**
 * The script WRITE path: the assembler (src/df/script-asm.ts) and the encoder
 ...
 * built by tools/mklangstg.ts) rests on: the engine must not be able to tell our
...
import { AssembleError, assembleScript, compileScript } from "../../src/df/script-asm";

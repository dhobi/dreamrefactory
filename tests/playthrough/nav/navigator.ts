...
export class Navigator {
  ...
  /**
   * Hold up your end of a conversation — see tests/playthrough/nav/converse.ts. Routes call
  ...
  /**
   * Set a control that has to be dragged — see tests/playthrough/nav/dials.ts. Which
   ...
   * skippable bit; see docs/formats/mov.md).
   *
   ...
   * sample it takes anyway (tests/browser/driver.ts `Mirror`).
   *
   ...
   * it (docs/verification.md, on `exitcode` and the 2nd-class staircase).
   *

 ...
 */
export async function turnDial(d: NavDriver, dial: DragDial, want: number): Promise<DialResult> {
...
function driven(d: NavDriver, c: DrivenControl): number | "nothing" {
 ...
 * number asked for.
 */
function driving(d: NavDriver, c: DrivenControl, deg: number): boolean {
...
export async function setLever(d: NavDriver, lever: DragLever, want: number): Promise<DialResult> {

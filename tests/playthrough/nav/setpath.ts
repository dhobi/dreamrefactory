 ...
 * {@link turnRing} — comes from src/df/set.ts, the same functions
 ...
 */
import { LEFTTURNS, RIGHTTURNS, roadsAt, turnRing } from "../../../src/df/set";
import type { Scene, SetFile } from "../../../src/df/set";

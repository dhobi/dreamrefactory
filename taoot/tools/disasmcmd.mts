 ...
 * the semantics of commands not yet implemented in engine/src/runtime/builtins.
 *
 ...
 *
 *   npx tsx taoot/tools/disasmcmd.mts path calcvectx calcvecty calcdeg
 */
import { readFileSync } from "node:fs";
import { Capstone, Const, loadCapstone } from "capstone-wasm";
import { OPCODES } from "@dreamfactory/engine/df/script";

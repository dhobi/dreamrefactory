 ...
 *
 *   npx tsx taoot/tools/mapjumps.ts
 *
 ...
 * with their rectangles and the script container each one runs (engine/src/df/stg.ts),
...
const emitted = `/* GENERATED by taoot/tools/mapjumps.ts — do not edit.
 ...
 * Regenerate: npx tsx taoot/tools/mapjumps.ts
 */

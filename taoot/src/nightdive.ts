 ...
 * language chooser is a stage and not a dialog (taoot/src/lang-chooser.ts): the file is
 * built by taoot/tools/mknightdive.ts, read by `readMovFile`, played by the engine's own
 ...
 * taoot/tools/mknightdive.ts. There is no catalogue behind a MOV frame and no string

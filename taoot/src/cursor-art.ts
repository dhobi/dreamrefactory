 ...
 *
 *   npx tsx tools/dumpcursors.ts demo/install/bin/ti.exe --out <this file> --const TI_CURSORS
 *
 * 11 `CURS.*` resources out of `ti.exe`, minus 2 that are duplicates under an old numeric name (curs131, curs2002).
...
export const TI_CURSORS: Record<string, CursorArt> = {

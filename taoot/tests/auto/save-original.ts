...
import { applyPatch, parseSave, readSaveFile, writeSaveFile } from "@dreamfactory/engine/df/savegame";
...
const SAVE = new Uint8Array(readFileSync(new URL("../data/M4P0FCL.ti", import.meta.url)));

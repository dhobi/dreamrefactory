 ...
 *
 * The route comes straight out of the scripts (docs/taoot/mission-flow.md), and
...
export async function segment3(s: Story): Promise<void> {
  ...
  // recept1c, gstair2 or gstair3 (engine/src/runtime/masks.ts), the map's jump to c73
...
export async function segment7(s: Story): Promise<void> {
  ...
  // docs/engine/formats/mov.md: an abort does NOT run the frame's action, which is
 ...
 *                  are what carry it (docs/engine/formats/mov.md, and segment 11).
 */
 ...
 * settled it the other way (docs/engine/formats/mov.md, "a chain can start at a region").
...
export async function segment11(s: Story): Promise<void> {
  ...
  // (docs/engine/formats/mov.md: 1 exits, 5 pops). So this is the last click, and
...
export async function segment18(s: Story): Promise<void> {
  ...
  // An abort ends it without running the frame's action (docs/engine/formats/mov.md), which
...
export async function segment21(s: Story): Promise<void> {
  ...
  // slots to make records in (docs/engine/formats/savegame.md), so a checkpoint cannot carry
 ...
 *
 * The maze is read out in [nav/smokestack.ts](taoot/tests/playthrough/nav/smokestack.ts)

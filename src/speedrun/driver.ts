 ...
 * boundary:
 *
 *   - `tests/speedrun/driver.ts` drives a real browser from Node over Playwright.
 ...
 *     record.
 *   - `src/speedrun/page-driver.ts` runs INSIDE the page, synthesizing DOM events
 ...
 * src/viewer.ts): a press made while a fade ramps is DISCARDED, no handler runs,

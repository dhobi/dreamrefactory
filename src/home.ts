 ...
 * speedrun workbench (src/konami.ts), which is built and deployed but unlisted
 ...
 * (tests/auto/locales.ts), which is a lot of ceremony for a joke.
 *
 ...
 * included (tests/auto/reproducible.ts). `getAnimations()` gives the exact

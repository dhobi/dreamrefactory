 ...
 *    (tests/auto/*-editor.ts) check that reading and writing a file preserves it
 ...
 *    stage this project wrote from nothing (tools/mklangstg.ts) and the engine
 ...
 * come from `compileScript` (src/df/script-asm.ts).
 */

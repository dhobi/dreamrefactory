 ...
 * globals table IS the game state (src/engine/trace.ts, and docs/04-mission-flow.md
 ...
 */
import { isHarnessPaced } from "./engine/masks";
import type { StateTrace } from "./engine/trace";

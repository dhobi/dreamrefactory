/**
 * Russian. The words are in the JSON files beside this one so that a
...
const ru: Catalogue = { common, counts, site, home, play, collection, editors, puppets, casts, sets, shops, stages, movies, tracks };
export default ru;

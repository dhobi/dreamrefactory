...
*Prerequisite: [How the game works](how-the-game-works.md) and
...
[a chain can start at a region](../engine/formats/mov.md#a-chain-can-start-at-a-region-not-only-at-a-frame).
...
itself a cost — see **[The sinking](sinking.md)** for the whole clock.
...
[the scripting language](../engine/scripting-language.md)), walks each statement while

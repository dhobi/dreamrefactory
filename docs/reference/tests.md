...
|----------|-----------|---------|------------|
| **automatic** | `tests/auto/` | `npm test` | scenario + unit suites that jump to a state and probe it — 444 tests, run on every commit |

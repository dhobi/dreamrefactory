...
[`engine/src/runtime/actors.ts`](https://github.com/dhobi/dreamrefactory/blob/master/engine/src/runtime/actors.ts) and
[`engine/src/runtime/puppet.ts`](https://github.com/dhobi/dreamrefactory/blob/master/engine/src/runtime/puppet.ts)
(logic) with
[`engine/src/web/puppet-view.ts`](https://github.com/dhobi/dreamrefactory/blob/master/engine/src/web/puppet-view.ts)
(drawing); the commands live in
[`builtins/actors.ts`](https://github.com/dhobi/dreamrefactory/blob/master/engine/src/runtime/builtins/actors.ts) and
[`builtins/puppets.ts`](https://github.com/dhobi/dreamrefactory/blob/master/engine/src/runtime/builtins/puppets.ts).
...
- **`puppetspeak(ident)`** — plays the line's voice audio and shows its
  ...
  ([the code page](../../taoot/languages.md#the-code-page-is-not-in-the-data)). Which

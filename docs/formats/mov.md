...
[`src/df/mov-pace.ts`](https://github.com/dhobi/taoot-web/blob/master/src/df/mov-pace.ts)
(the pacing rule, kept in one place so the player and the editor cannot each have
their own idea of it),
[`src/df/mov-build.ts`](https://github.com/dhobi/taoot-web/blob/master/src/df/mov-build.ts)
(the write half — a movie, or a chain of segments, built from nothing) and
[`src/movie-player.ts`](https://github.com/dhobi/taoot-web/blob/master/src/movie-player.ts)
...
[`mov-pace.ts`](https://github.com/dhobi/taoot-web/blob/master/src/df/mov-pace.ts)
...
- **[the movie editor](../editors/movies.md)** (`/editors/movies.html`)
  ...
  above.
- **[`tools/mknightdive.ts`](https://github.com/dhobi/taoot-web/blob/master/tools/mknightdive.ts)**
...
- **[`tests/auto/mov-format.ts`](https://github.com/dhobi/taoot-web/blob/master/tests/auto/mov-format.ts)**

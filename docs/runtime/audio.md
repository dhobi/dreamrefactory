...
[`src/engine/audio.ts`](https://github.com/dhobi/taoot-web/blob/master/src/engine/audio.ts)
(`AudioLibrary` + the sinks); the commands are in
[`builtins/audio.ts`](https://github.com/dhobi/taoot-web/blob/master/src/engine/builtins/audio.ts).
...
[`df/audio.ts`](https://github.com/dhobi/taoot-web/blob/master/src/df/audio.ts),
...
chipmunk against its true 73.4 s. `tests/auto/audio-rates.ts` asserts a theme

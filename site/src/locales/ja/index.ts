/**
 * Japanese. The words are in the JSON files beside this one so that a
 ...
 * error. site/tests/locales.ts covers what a type cannot see: an extra key, an
...
const ja: Catalogue = { common, counts, site, front, home, play, collection, minigames, editors, puppets, casts, sets, shops, stages, movies, tracks };
export default ja;

/**
 * Dutch. The words are in the JSON files beside this one so that a
...
const nl: Catalogue = { common, counts, site, front, home, play, collection, minigames, editors, puppets, casts, sets, shops, stages, movies, tracks };
export default nl;

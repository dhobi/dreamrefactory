...
export const en = {
  ...
  front: {
    ...
    lede: "CyberFlix built an engine. Bill Appleton's <b>DreamFactory</b> was a CD-ROM authoring system, and the studio's games were made with it — <i>Lunicus</i> (1993), <i>Jump Raven</i>, <i>Dust: A Tale of the Wired West</i>, <i>Titanic: Adventure Out of Time</i> — and other studios licensed it besides: <i>Timelapse: Ancient Civilizations</i> is <b>GTE Interactive Media</b>'s. CyberFlix closed in 1998, the year of its last game, <i>Redjack: Revenge of the Brethren</i>. dreamREfactory is that engine written again in TypeScript, from the files rather than from the source — every container format decoded, the script language parsed and interpreted, and the games played in a browser with nothing installed. <b>Three of them are here.</b>" as Html,

/**
 * German. The words are in the JSON files beside this one so that a
...
const de: Catalogue = { common, counts, site, front, home, play, collection, minigames, editors, puppets, casts, sets, shops, stages, movies, tracks };
export default de;
